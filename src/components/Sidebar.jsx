...
const Sidebar = () => {
  ...
  // const isBulletin = location.pathname === "/bulletin"; // Removed isBulletin
  ...
  return (
    <aside id="sidebar" className="sidebar">
      <ul className="sidebar-nav" id="sidebar-nav">
        ...
        <li className="nav-item">
          <a
            className={`nav-link ${isAddEmployee || isViewEmployee ? "" : "collapsed" }`}
          ...
          <ul
            id="employees-nav"
            className={`nav-content collapse ${isAddEmployee || isViewEmployee ? "show" : "" }`}
        ...
        <li className="nav-item">
          ...
          <ul id="settings-nav" className={`nav-content collapse ${isSettingsActive ? "show" : "" }`} data-bs-parent="#sidebar-nav">
            ...
            <Link to="/settings/admin-user" style={{ padding: "0" }} className={location.pathname === "/settings/admin-user" ? "active" : ""}>
              <li className="mt-2">
                <a>
            ...
            <Link to="/settings/bulletin" style={{ padding: "0" }} className={location.pathname === "/settings/bulletin" ? "active" : ""}>
              <li className="mt-2">
                <a>
        ...
        {/* New top-level items placed below Settings */}
        <Link to="/attendance" style={{ padding: "0" }} className={isAttendance ? "active" : ""}>
        ...
        <Link to="/dtr" style={{ padding: "0" }} className={isDTR ? "active" : ""}>
          <li className="nav-item mt-2">
            <a className="nav-link">
        ...
        <Link to="/payroll" style={{ padding: "0" }} className={isPayroll ? "active" : ""}>
          <li className="nav-item mt-2">
            <a className="nav-link">
